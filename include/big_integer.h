...
namespace atib {
  namespace numerics {
    ...
    public:
      ...
      const std::string &get_big_integer(
        const number_base base = number_base::decimal) const noexcept;
      ...
      const std::string &get_hexadecimal_number(const std::string &prefix = "0x", const std::string &postfix = "", const size_t number_of_digits = 0);

      const std::string &get_decimal_number() const;

      const std::string &get_octal_number(const std::string &prefix = "0o", const std::string &postfix = "", const size_t number_of_digits = 0);

      const std::string &get_binary_number(const std::string &prefix = "0b", const std::string &postfix = "", const size_t number_of_digits = 0);
    ...
    private:
      ...
      static char get_correct_digit_character_for_specified_value(const char ch) noexcept;
