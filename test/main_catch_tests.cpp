...
TEST_CASE("big_integer operator+(const big_integer&, const big_integer&)",
  "Testing expected corerct functionality of the globally defined "
  "addition operator.")
{
  const int64_t lower_limit{ -(1LL << 31) };
  const int64_t upper_limit{ (1LL << 31) - 1 };
...
TEST_CASE("big_integer operator-(const big_integer&, const big_integer&)",
  "Testing expected correct functionality of the globally defined "
  "minus operator.")
{
  const int64_t lower_limit{ -(1LL << 31) };
  const int64_t upper_limit{ (1LL << 31) - 1 };
  ...
  "Testing big_integer's operator++() public method")
{
  ...
  big_integer minus_one{ big_integer::negative_one };
  REQUIRE(++minus_one == big_integer::zero);

  big_integer zero{ big_integer::zero };
  REQUIRE(++zero == big_integer::positive_one);
  ...
  "Testing big_integer's operator++(int) const public method")
{
  ...
  big_integer minus_one{ big_integer::negative_one };
  REQUIRE(minus_one++ == big_integer::negative_one);
  REQUIRE(minus_one == big_integer::zero);
  ...
  "Testing big_integer's operator--() public method")
{
  ...
  big_integer positive_one{ big_integer::positive_one };
  REQUIRE(--positive_one == big_integer::zero);

  big_integer zero{ big_integer::zero };
  REQUIRE(--zero == big_integer::negative_one);
...
{
  big_integer positive_one{ big_integer::positive_one };
  REQUIRE(positive_one-- == big_integer::positive_one);
  REQUIRE(positive_one == big_integer::zero);
